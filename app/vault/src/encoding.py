...
class Magic(object):
    ...
    groupNode  = [hdr, u("!I", "GRUP")] # for generating keys for individual
                                        # password groups.
                                        # the unlock and backup key is written
                                        # in this weird way to fit display
                                        # nicely.
    unlockKey  = "Decrypt master  key?" # string to derive wrapping key from.
    backupNode = [hdr, u("!I", "BKUP")] # for unlocking wrapped backup private
                                        # RSA key.
    backupKey  = "Decrypt backup  key?" # string to derive backup wrapping key
                                        # from.
