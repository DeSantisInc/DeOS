...
cp src/spinner.sh bin/darwin/spinner
chmod +x bin/darwin/spinner

cp src/deos.py bin/darwin/deos
chmod +x bin/darwin/deos

cp src/print.py bin/darwin/printm
chmod +x bin/darwin/printm
...
bash -c "\
source venv/darwin/blockstack/bin/activate\
